...
# aggregated_df_line_item.to_csv('check.csv', index=True)
# print(aggregated_df)
df_plan.columns
...
df_merged.loc[:,['Campaign Name','Line_Item','Date','Phase/inputs',"Schedule", "Genre", "Publisher", "Platform", "Section", "Creative", "Creative Name", "Geo", "Targeting", "Amazon/Rufus", "Deal Type", 'Planned Impressions','Delivered Impressions','Planned Clicks','Delivered Clicks','Planned Video Views','Delivered Video Views (True Views)','25% Views', '50% Views', '75% Views', '100% Views','Planned Spends','Delievered Spends']].to_csv('merged_plan_report.csv', index=False) 
...
df_merged_concept = df_merged_concept.groupby(['Campaign Name','Line_Item','Date','Phase/inputs',"Schedule", "Genre", "Publisher", "Platform", "Section", "Creative", "Creative Name", "Geo", "Targeting", "Amazon/Rufus", "Deal Type",'Concept Name']).agg({
...
df_merged_concept.loc[:,['Campaign Name','Line_Item','Date','Phase/inputs',"Schedule", "Genre", "Publisher", "Platform", "Section", "Creative", "Creative Name", "Geo", "Targeting", "Amazon/Rufus", "Deal Type", 'Concept Name' ,'Delivered Impressions','Delivered Clicks','Delivered Video Views (True Views)','25% Views', '50% Views', '75% Views', '100% Views','Delievered Spends']].to_csv('merged_plan_concept_report.csv', index=False)
