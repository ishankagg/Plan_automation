...
df_merged.loc[:,['Campaign Name','Line_Item','Date','Phase/inputs',"Geo", "Cohort", "Genre", "Publisher", "Devices", "Section", "Ad Unit", "Ad Size", "Creatives", "Language", "Targeting", "Deal Type",'Planned Impressions','Delivered Impressions','Planned Clicks','Delivered Clicks','Planned Video Views','Delivered Video Views (True Views)','25% Views', '50% Views', '75% Views', '100% Views','Planned Spends','Delievered Spends']].to_csv('merged_plan_report.csv', index=False) 
...
df_merged_concept = df_merged_concept.groupby(['Campaign Name','Line_Item','Date','Phase/inputs','Geo', 'Genre', 'Publisher', 'Devices', 'Section', 'Ad Unit', 'Ad Size', 'Creatives', 'Language', 'Targeting', 'Deal Type','Concept Name', 'Cohort']).agg({
...
df_merged_concept.loc[:,['Campaign Name','Line_Item','Date','Phase/inputs',"Geo", "Cohort", "Genre", "Publisher", "Devices", "Section", "Ad Unit", "Ad Size", "Creatives", "Language", "Targeting", "Deal Type",'Concept Name' ,'Delivered Impressions','Delivered Clicks','Delivered Video Views (True Views)','25% Views', '50% Views', '75% Views', '100% Views','Delievered Spends']].to_csv('merged_plan_concept_report.csv', index=False)
