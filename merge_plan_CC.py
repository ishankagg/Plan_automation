...
df_merged.loc[:,['Campaign Name','Line_Item','Date','Phase/inputs','State', 'Geo Cut', 'Audience Cohort','Platform','Publisher','Devices', 'Section','Ad Unit', 'Ad Size', 'Language', 'Deal Type', 'Planned Impressions','Delivered Impressions','Planned Clicks','Delivered Clicks','Planned Video Views','Delivered Video Views (True Views)','25% Views', '50% Views', '75% Views', '100% Views','Planned Spends','Delievered Spends']].to_csv('merged_plan_report.csv', index=False) 
...
df_merged_concept = df_merged_concept.groupby(['Campaign Name','Line_Item','Concept Name','Date','Phase/inputs','State', 'Geo Cut', 'Audience Cohort','Platform','Publisher','Devices', 'Section','Ad Unit', 'Ad Size', 'Language', 'Deal Type']).agg({
...
df_merged_concept.columns

df_merged_concept.loc[:,['Campaign Name','Line_Item','Concept Name','Date','Phase/inputs','State', 'Geo Cut', 'Audience Cohort','Platform','Publisher','Devices', 'Section','Ad Unit', 'Ad Size', 'Language', 'Deal Type','Delivered Impressions','Delivered Clicks','Delivered Video Views (True Views)','25% Views', '50% Views', '75% Views', '100% Views','Delievered Spends']].to_csv('merged_plan_concept_report.csv', index=False)
